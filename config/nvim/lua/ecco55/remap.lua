...
local non_lsp_mappings = {
    -- Leader Mappings
    { "<leader>e", function() vim.cmd.Ex() end, desc = "Open file explorer", mode = "n" },
...
local harpoon_mappings = {
    ...
    {"<C-e>", function() toggle_telescope(harpoon:list()) end, desc = "Show Harpoon Menu", mode="n"},
...
local telescope_mappings = {
  ...
  { "<C-p>", function() builtin.git_files() end, desc = "Find git files", mode="n"},
